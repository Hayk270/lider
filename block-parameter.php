...
$height = 200;
		...
		<h5 class="style-title-grid"><a href="view_content.php?id='.$row["products_id"].'" >'.$row["title"].'</a></h5>
		<p id="type_count-list">(1 '.$row["type_count"].'= '.$row["price"].' դրամ)</p>
		<center><a href="view_content.php?id='.$row["products_id"].'"><div class="grid-sale'.$row["sale"].'"><span>'.$row["old_price"].' դրամ</span></div></a></center>
		<div id="price-add">
...
$height = 200;
		...
		<center><a href="view_content.php?id='.$row["products_id"].'"><div class="list-sale'.$row["sale"].'"><span>'.$row["old_price"].' դրամ</span></div></a></center>
		</p>
