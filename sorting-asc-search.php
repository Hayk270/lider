...
if ($temp[0] > 0)
	...
	<div id="block-sorting">
		...
		<li><a href="sorting-desc-search.php?q='.$search.'">Սկզբում թանկերը</a></li>
		</ul>
	</div>
		<ul id="block-tovar-grid">';
	$result = mysql_query("SELECT * FROM table_products WHERE title LIKE '%$search%' OR seo_words LIKE '%$search%' AND visible='1' ORDER BY price asc $qury_start_num ",$link);
